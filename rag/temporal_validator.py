...
HISTORICAL_PERIODS = {
    # Getúlio Vargas
    "governo provisório vargas": {"start": 1930, "end": 1934, "aliases": ["governo provisório", "revolução de 1930"]},
    "governo constitucional vargas": {"start": 1934, "end": 1937, "aliases": ["governo constitucional"]},
    "estado novo": {"start": 1937, "end": 1945, "aliases": ["estado novo vargas", "ditadura vargas"]},
    "era vargas": {"start": 1930, "end": 1945, "aliases": ["primeiro período vargas", "primeira era vargas"]},
    "segundo governo vargas": {"start": 1951, "end": 1954, "aliases": ["segundo mandato vargas", "governo democrático vargas"]},
    
    # Outros períodos importantes
    "primeira guerra mundial": {"start": 1914, "end": 1918, "aliases": ["primeira guerra", "grande guerra"]},
    "segunda guerra mundial": {"start": 1939, "end": 1945, "aliases": ["segunda guerra", "wwii"]},
    "revolução industrial": {"start": 1760, "end": 1840, "aliases": ["industrialização"]},
    "império napoleônico": {"start": 1804, "end": 1814, "aliases": ["napoleão imperador", "império francês"]},
    "consulado napoleão": {"start": 1799, "end": 1804, "aliases": ["consulado francês", "napoleão cônsul"]},
}
    ...
    if query_period and response_period:
        if query_period["name"] != response_period["name"]:
            ...
            query_contains_response = (
                query_range[0] <= response_range[0] and 
                query_range[1] >= response_range[1]
            )
            response_contains_query = (
                response_range[0] <= query_range[0] and 
                response_range[1] >= query_range[1]
            )
