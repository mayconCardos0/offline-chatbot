...
def next_metrics_version(metrics_dir: Path) -> int:
    ...
    Compartilhado por todos os scripts que exportam métricas versionadas
    (eval_rag.py para retrieval, eval_generation.py para generation) — cada
    diretório de métricas tem seu próprio contador independente.
    """
